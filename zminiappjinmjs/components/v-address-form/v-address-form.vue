<template>
	<uni-popup ref="addressFormPopup" background-color="#fff" mask-background-color="#000000dd">
		<view class="container-v main">
			<form>
				<view class="form-item">
					<view class="uni-h6 v-mb-10 require">选择区域:</view>
					<v-address-picker :cities="cities" @change="addressChange" v-model="item.district"></v-address-picker>
				</view>
				<view class="form-item">
