...
const uni_modules_uvParse_components_uvParse_parser = require("./parser.js");
...
const _sfc_main = {
  ...
  methods: {
    ...
    setContent(content, append) {
      ...
      const nodes = new uni_modules_uvParse_components_uvParse_parser.Parser(this).parse(content);
