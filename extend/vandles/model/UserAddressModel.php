...
class UserAddressModel extends BaseSoftDeleteModel {

    protected $name = 'AUserAddress';
    ...
    public function schema($isDeleteTable = false) {
        ...
        (
            ...
            `openid`   varchar(50) not null comment 'gid',
            ...
            index `idx_{$table}6` (`is_default`) using btree,
